function [t,y,te,ye,ie] = ode_nonstat_to_init(input)

%% Simulate (in reverse) the state and costate transitions for the
% non-stationary inertia model before the negative emissions constraint
% binds
...
[t,y,te,ye,ie] = ode23(@(t,y) state_path_nonstat(t, y, timespace, emissions), timespace, input, options_ode);
